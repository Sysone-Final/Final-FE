...
const OptionCheckbox = ({
  ...
  return (
    <label className="option-checkbox-label">
      ...
      />
      <span className="option-checkbox-text">{label}</span>
    </label>
  );
};
  ...
  return (
    <div className="display-options-container">
      ...
      <div className="option-section">
        <h4 className="option-section-title">기본정보</h4>
      ...
      {/* 상태 & 성능 섹션 */}
      <div className="option-section">
        <h4 className="option-section-title">상태 & 성능</h4>
        <div className="option-group">
      ...
      {/* 전문 정보 섹션 */}
      <div className="option-section">
        <h4 className="option-section-title">전문 정보</h4>
        <div className="option-group">
      ...
      {/* 설비/안전 섹션 */}
      <div className="option-section">
        <h4 className="option-section-title">설비/안전</h4>
        <div className="option-group">
      ...
      {/* 표시 설정 섹션 */}
      <div className="option-section">
        <h4 className="option-section-title">표시 설정</h4>
        <div className="option-group">
